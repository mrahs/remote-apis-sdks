...
func TestBatching_WriteBytes(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantStats: casng.Stats{
				BytesRequested:       3500,
				BytesWiredEffective:  29,
				BytesWiredTotal:      29,
				BytesTransferred:    3500,
				BytesStreamed: 3500,
				CasMissCount:       1,
				StreamedCount:        1,
			},
		...
		},
		{
			...
			wantStats: casng.Stats{
				BytesRequested:       3,
				BytesWiredEffective:  2, // matches buffer size
				BytesWiredTotal:      2,
				BytesTransferred:    2,
				BytesStreamed: 2,
				CasHitCount:        1,
		...
		},
		{
			...
			wantStats: casng.Stats{
				BytesRequested:       3,
				BytesWiredEffective:  2, // matches one buffer size
				BytesWiredTotal:      4, // matches two buffer sizes
				BytesTransferred:    2,
				BytesStreamed: 2,
				CasMissCount:       1,
				StreamedCount:        0,
